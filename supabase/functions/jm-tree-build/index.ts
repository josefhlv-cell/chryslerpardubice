...
const DEFAULT_TREE = [
  { name: "Bezpečnostní systém", subcategories: ["Airbagy", "Bezpečnostní pásy"] },
  { name: "Brzdové zařízení", subcategories: ["Kotoučové brzdy", "Bubnové brzdy", "Hydraulika brzd", "Parkovací brzda", "ABS / regulace jízdní dynamiky"] },
  { name: "Čištění skel", subcategories: ["Stěrače", "Ostřikovače"] },
  { name: "Díly pro servis / kontrolu / údržbu", subcategories: ["Servisní sady", "Nářadí", "Univerzální / montážní díly"] },
  { name: "Elektroinstalace", subcategories: ["Alternátory", "Startéry", "Baterie", "Relé / pojistky / spínače", "Kabeláž / konektory", "Řídicí jednotky"] },
  { name: "Filtry", subcategories: ["Olejové filtry", "Vzduchové filtry", "Kabinové / pylové filtry", "Palivové filtry", "Filtry převodovky"] },
  { name: "Chlazení", subcategories: ["Chladiče vody", "Chladiče oleje", "Termostaty", "Vodní čerpadla", "Ventilátory chlazení", "Hadice / nádržky chlazení", "Mezichladiče"] },
  { name: "Karosérie", subcategories: ["Nárazníky / výztuhy", "Přední část / maska", "Kapoty / blatníky / prahy", "Zrcátka", "Dveře / víka", "Skla / stahování oken"] },
  { name: "Klimatizace", subcategories: ["Kompresory klimatizace", "Kondenzátory", "Vysoušeče / sušiče", "Expanzní ventily", "Výparníky", "Hadice klimatizace"] },
  { name: "Komfortní systémy", subcategories: ["Parkovací asistenty", "Tempomat", "Vyhřívání"] },
  { name: "Kola / pneumatiky", subcategories: ["Pneumatiky", "Disky kol", "TPMS / ventilky", "Šrouby / matice kol"] },
  { name: "Motor", subcategories: ["Těsnění", "Hlava válců / ventilový rozvod", "Klikový mechanismus", "Mazání motoru", "Uložení motoru", "Sání motoru", "Rozvody"] },
  { name: "Odpružení / tlumení", subcategories: ["Tlumiče", "Pružiny", "Uložení / dorazy tlumičů"] },
  { name: "Palivové čerpadlo", subcategories: ["Elektrická palivová čerpadla", "Moduly palivového čerpadla"] },
  { name: "Palivový systém", subcategories: ["Nádrž / víčko / klapka", "Palivové vedení", "Regulace tlaku paliva"] },
  { name: "Příprava paliva", subcategories: ["Vstřikovače / trysky", "Vstřikovací rampa", "Karburátor"] },
  { name: "Pohon kol", subcategories: ["Hnací hřídele / poloosy", "Klouby / manžety poloos"] },
  { name: "Pohon nápravy", subcategories: ["Diferenciál", "Kardany", "Rozvodovka"] },
  { name: "Převodovka", subcategories: ["Automatická převodovka", "Manuální převodovka", "Řazení / volič", "Olej převodovky"] },
  { name: "Příslušenství", subcategories: ["Tažné zařízení", "Nosiče / střešní systémy", "Doplňky interiéru"] },
  { name: "Řemenový pohon", subcategories: ["Drážkové / klínové řemeny", "Napínáky a kladky", "Řemenice"] },
  { name: "Řízení", subcategories: ["Řídicí mechanismus", "Uložení řízení", "Táhla / čepy řízení", "Manžety řízení", "Servořízení", "Volant"] },
  { name: "Spojka", subcategories: ["Spojkové sady", "Spojkový kotouč / přítlačný talíř", "Vypínací ložiska", "Spojkové válce", "Setrvačníky"] },
  { name: "Snímače", subcategories: ["Snímače motoru", "Lambda sondy", "Snímače otáček / rychlosti", "Parkovací snímače"] },
  { name: "Topení / ventilace", subcategories: ["Radiátory topení", "Ventilátory / odpory topení", "Ovládání topení"] },
  { name: "Vnitřní vybavení", subcategories: ["Palubní deska / ovladače", "Sedadla", "Obložení interiéru"] },
  { name: "Výfuk", subcategories: ["Výfukové potrubí", "Tlumiče výfuku", "Katalyzátory / DPF", "Těsnění výfuku", "EGR"] },
  { name: "Zamykací zařízení", subcategories: ["Zámky dveří", "Centrální zamykání", "Vložky zámků / klíče"] },
  { name: "Zapalování / žhavicí zařízení", subcategories: ["Zapalovací svíčky", "Zapalovací cívky", "Žhavicí svíčky", "Rozdělovač / kabely"] },
  { name: "Zavěšení nápravy / Vedení kol", subcategories: ["Ramena / vedení kol", "Pouzdra / silentbloky", "Čepy nápravy", "Náboje / ložiska kol", "Stabilizátor"] },
  { name: "Osvětlení", subcategories: ["Světlomety", "Zadní světla", "Směrovky", "Žárovky", "Mlhovky"] },
];
