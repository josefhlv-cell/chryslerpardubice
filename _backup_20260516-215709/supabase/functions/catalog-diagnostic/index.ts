...
const CATEGORY_ALIASES: Record<string, string> = {
  ...
  "podvozek": "Odpružení",
  "podvozek a řízení": "Odpružení",
  "shock absorbers": "Odpružení",
  "tlumiče": "Odpružení",
  ...
  "timing": "Motor",
  "rozvody": "Motor",
  "ignition": "Elektroinstalace",
  "zapalování": "Elektroinstalace",
  "clutch": "Převodovka",
  "spojka": "Převodovka",
  "steering": "Řízení",
  "fluids": "Kapaliny a oleje",
  "oils": "Kapaliny a oleje",
  "náplně a maziva": "Kapaliny a oleje",
};
...
const CATEGORY_KEYWORDS: { keywords: string[]; category: string }[] = [
  ...
  { keywords: ["tlumič", "pružin", "shock", "absorber", "stossdaempfer", "rameno", "silentblok"], category: "Odpružení" },
  ...
  { keywords: ["výfuk", "exhaust", "katalyz", "tlumič výfuk"], category: "Výfuk" },
  ...
  { keywords: ["rozvod", "timing", "řemen", "napín"], category: "Motor" },
  { keywords: ["zapal", "svíčk", "ignition", "cívk", "zuendkerze"], category: "Elektroinstalace" },
  { keywords: ["spojk", "clutch", "vypínací"], category: "Převodovka" },
  { keywords: ["řízení", "steering", "tyč řízení", "kloub řízení"], category: "Řízení" },
  { keywords: ["olej", "kapalin", "mazivo", "fluid", "antifreez", "nemrznou"], category: "Kapaliny a oleje" },
  { keywords: ["ložisko", "uložení motoru", "podvozek"], category: "Odpružení" },
];
